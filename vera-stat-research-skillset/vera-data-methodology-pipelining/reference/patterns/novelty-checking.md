...
- REVIEWER_MODEL = `gpt-5.4` — Model used through the configured reviewer bridge.
...
Call REVIEWER_MODEL through the configured reviewer bridge with xhigh reasoning:
```
