...
```
Read and execute reference/patterns/literature-reviewing.md with context: "$ARGUMENTS"
```
...
```
Read and execute reference/patterns/idea-creating.md with context: "$ARGUMENTS"
```
...
```
Read and execute reference/patterns/novelty-checking.md with context: "[idea description]"
```
...
```
Read and execute reference/patterns/research-reviewing.md with context: "$ARGUMENTS — focusing on top ideas from idea report"
```
...
- [ ] Run full simulation study: read and execute reference/patterns/experiment-running.md
- [ ] Iterate with review: read and execute reference/patterns/review-looping.md
- [ ] Write the paper: read and execute reference/patterns/paper-writing.md
```
