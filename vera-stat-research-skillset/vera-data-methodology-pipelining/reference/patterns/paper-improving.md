...
4. Compile current version: Read and execute `reference/patterns/paper-compiling.md` → save as `round0_original.pdf`
...
1. Read and execute `reference/patterns/paper-compiling.md`
