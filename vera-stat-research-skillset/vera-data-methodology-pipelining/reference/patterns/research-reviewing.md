...
# Statistics Research Review Through The Configured Reviewer Bridge

Get a multi-round critical review of statistics research work from an external
reviewer bridge when available, or use the same prompt as a structured
...
- Optional external reviewer bridge, such as Codex MCP or another bridge that
  accepts the same prompt context.
