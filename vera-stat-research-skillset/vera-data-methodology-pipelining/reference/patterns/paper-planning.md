...
- **TARGET_VENUE = `JASA`** — Default venue. User can override (e.g., invoke paper-planning with context: "topic" — venue: Annals).
...
## Next Steps
- [ ] Read and execute reference/patterns/figure-creating.md to generate simulation plots
- [ ] Read and execute reference/patterns/manuscript-writing.md to draft LaTeX
- [ ] Read and execute reference/patterns/paper-compiling.md to build PDF
```
