...
> **Executor**: Main Agent (invokes `reference/patterns/paper-writing.md`)
...
#### Phase 1: Paper Planning (`reference/patterns/paper-planning.md`)
...
#### Phase 2: Figure Generation (`reference/patterns/figure-creating.md`)
...
#### Phase 3: LaTeX Writing (`reference/patterns/manuscript-writing.md`)
...
#### Phase 4: Compilation (`reference/patterns/paper-compiling.md`)
...
#### Phase 5: Writing Improvement (`reference/patterns/paper-improving.md`)
