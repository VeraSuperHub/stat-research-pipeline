...
```
Read and execute reference/patterns/experiment-running.md
```
...
```
Read and execute reference/patterns/experiment-monitoring.md
```
...
```
Read and execute reference/patterns/results-analyzing.md
```
