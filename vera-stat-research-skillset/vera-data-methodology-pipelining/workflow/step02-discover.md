...
```
Read and execute reference/patterns/literature-reviewing.md with context: "{research_direction}"
```
...
```
Read and execute reference/patterns/idea-creating.md with context: "{research_direction}"
```
...
```
Read and execute reference/patterns/novelty-checking.md
```
...
```
Read and execute reference/patterns/research-reviewing.md
```

Submit top ideas to the configured reviewer bridge, when available, for
