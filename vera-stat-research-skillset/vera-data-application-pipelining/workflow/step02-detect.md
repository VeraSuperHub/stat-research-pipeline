...
Read `reference/rules/outcome-detection-rules.md` for the full decision tree.
...
Look up the confirmed outcome type in `reference/specs/skill-routing-table.md`.
