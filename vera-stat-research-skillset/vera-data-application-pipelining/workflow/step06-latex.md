...
The `reference/patterns/paper-planning.md` procedure expects specific root-level files, NOT `output/manuscript.md`.
...
```
Read and execute reference/patterns/paper-planning.md with context: "$ARGUMENTS"
```
...
```
Read and execute reference/patterns/figure-creating.md
```
...
```
Read and execute reference/patterns/manuscript-writing.md with context: "$ARGUMENTS"
```
