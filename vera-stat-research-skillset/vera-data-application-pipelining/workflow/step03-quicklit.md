...
Read and execute `reference/patterns/literature-reviewing.md` with a focused query:

```
Read and execute reference/patterns/literature-reviewing.md with context: "{research_question} {outcome_type} analysis methods {discipline}"
```
...
**CRITICAL**: Read `reference/specs/method-tracks.md` and look up the EXACT track table for
...
## Source: reference/specs/method-tracks.md — [outcome type] section
