...
Read `reference/templates/manuscript-template.md` for the exact Markdown structure.
Read `reference/rules/assembly-rules.md` for stitching, numbering, and cross-referencing rules.
...
Generate NEW content. Read `reference/patterns/discussion-patterns.md` for structure.
