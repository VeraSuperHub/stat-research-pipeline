...
for dv in dvs:
    ...
    plt.suptitle('')
    fig.tight_layout()
    fig.savefig(os.path.join(figures_dir, f'plot_03_univariate_{dv}.png'), dpi=300)
    plt.close()
...
anova_df.to_csv(os.path.join(tables_dir, 'univariate_anova_table.csv'))

# Save pairwise table
if pairwise_results:
    pw_df = pd.DataFrame(pairwise_results)
    pw_df.to_csv(os.path.join(tables_dir, 'pairwise_table.csv'), index=False)
...
disc_table.to_csv(os.path.join(tables_dir, 'discriminant_table.csv'), index=False)
conf_mat_df.to_csv(os.path.join(tables_dir, 'confusion_matrix.csv'))
...
ax.legend()
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_04_discriminant.png'), dpi=300)
plt.close()
...
ax.legend()
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_06_profile.png'), dpi=300)
plt.close()
...
ax.legend()
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_07_cca.png'), dpi=300)
plt.close()
...
cca_table.to_csv(os.path.join(tables_dir, 'cca_table.csv'), index=False)
...
ax.legend()
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_09_scree.png'), dpi=300)
plt.close()
...
ax.legend()
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_10_biplot.png'), dpi=300)
plt.close()
...
pca_table.to_csv(os.path.join(tables_dir, 'pca_table.csv'), index=False)
...
ax.legend()
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_11_territorial.png'), dpi=300)
plt.close()
...
mvreg_summary.to_csv(os.path.join(tables_dir, 'mvreg_table.csv'), index=False)
...
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_12_mv_regression.png'), dpi=300)
plt.close()
...
fig.tight_layout()
fig.savefig(os.path.join(figures_dir, 'plot_13_importance_heatmap.png'), dpi=300)
plt.close()
print("\n  Saved: figures/plot_13_importance_heatmap.png")

# Save importance table
imp_combined.to_csv(os.path.join(tables_dir, 'importance_table.csv'))
...
convergence_df[display_cols].to_csv(os.path.join(tables_dir, 'convergence_table.csv'), index=False)
