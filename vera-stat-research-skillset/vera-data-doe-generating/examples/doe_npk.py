...
ax.legend()
plt.tight_layout()
plt.savefig(os.path.join(figures_dir, "plot_03_effect_ranking.png"), dpi=300)
plt.close()
...
if "N" in block_effects and len(block_effects["N"]) > 1:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(figures_dir, "plot_04_block_forest.png"), dpi=300)
    plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(figures_dir, "plot_05_halfnormal.png"), dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(figures_dir, "plot_06_contour.png"), dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(figures_dir, "plot_07_surface.png"), dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(figures_dir, "plot_08_residual_diagnostics.png"), dpi=300)
plt.close()
...
if rf_importance is not None or lgb_importance is not None:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(figures_dir, "plot_09_importance.png"), dpi=300)
    plt.close()
...
methods_path = os.path.join(output_dir, "methods.md")
